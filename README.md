...
**Текущая версия:** [v0.7.7](https://github.com/yalyoha/JuniorTorrentClient/releases/latest)
— компактный диалог выбора файлов (клик по строке переключает галку, вместо
горизонтальной прокрутки — многоточие), выбор файлов теперь по путям (устойчив к
BEP-47 padding), и авто-проверка хеша после завершения — недокачанные куски
подхватываются без ручного «Обновить».
