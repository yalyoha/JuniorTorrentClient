...
**Текущая версия:** [v0.7.8](https://github.com/yalyoha/JuniorTorrentClient/releases/latest)
— диалог выбора файлов теперь по-настоящему вписан в окно приложения (не вылезает
за края, не даёт горизонтальной прокрутки, высота адаптируется к окну — все серии
видны и в оконном режиме).
