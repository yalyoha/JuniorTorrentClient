...
**Текущая версия:** [v0.7.5](https://github.com/yalyoha/JuniorTorrentClient/releases/latest)
— партиальный выбор файлов в раздаче теперь корректно доходит до состояния «Раздача»
(раньше такие торренты бесконечно перепроверялись).
