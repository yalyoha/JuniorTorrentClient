...
**Текущая версия:** [v0.7.9](https://github.com/yalyoha/JuniorTorrentClient/releases/latest)
— исправлены чекбоксы в диалоге выбора файлов: клик по чекбоксу больше не
сбрасывается обратным toggle'ом от клика по строке.
