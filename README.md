...
**Текущая версия:** [v0.7.6](https://github.com/yalyoha/JuniorTorrentClient/releases/latest)
— диалог выбора файлов снова показывает имена файлов и размеры (не только номера),
подходит и для сериалов, и для игр / произвольных многофайловых раздач.
